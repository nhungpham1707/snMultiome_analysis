...
# save model 
with open(save_dir+'rna_model_20epoch.pkl', 'wb') as file:
...
# fig.tight_layout()
fig.savefig(save_dir+'rna_losses_20epoch.png')
...
sc.tl.umap(embed)
with open(save_dir+'rna_embed_20epo.pkl', 'wb') as file:
...
fig.savefig(save_dir+'umap_20epo.png')
