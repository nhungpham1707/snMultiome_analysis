...
# save model 
with open(save_dir+'rna_model_10epoch.pkl', 'wb') as file:
...
# fig.tight_layout()
fig.savefig(save_dir+'rna_losses_10epoch.png')
...
sc.tl.umap(embed)
with open(save_dir+'rna_embed_10epo.pkl', 'wb') as file:
...
fig.savefig(save_dir+'umap_10epo.png')
